import { ruleOfLowerCase, ruleOfUpperCase, ruleOfInt, ruleOfAlphabets, ruleOfURL, ruleOfPhoneNumber, ruleOfEmail, regOfSpecial, ruleOfHost, ruleOfSocialCreditCode, ruleOfXTOName } from './rules'
...
export function validNameOfXTO(str) {
  return ruleOfXTOName.test(str)
}
